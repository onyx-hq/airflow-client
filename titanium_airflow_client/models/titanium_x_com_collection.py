...
from titanium_airflow_client.models.titanium_titanium_x_com_collection_item import TitaniumTitaniumXComCollectionItem
from typing import Optional, Set
from typing_extensions import Self

class TitaniumXComCollection(BaseModel):
    """
    ...
    xcom_entries: Optional[List[TitaniumTitaniumXComCollectionItem]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.xcom_entries:
            for _item in self.xcom_entries:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xcom_entries": [TitaniumTitaniumXComCollectionItem.from_dict(_item) for _item in obj["xcom_entries"]] if obj.get("xcom_entries") is not None else None
        })
        return _obj
