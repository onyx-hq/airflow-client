...
class TitaniumHealthInfo(BaseModel):
    """
    Instance status information.
    """ # noqa: E501
    metadatabase: Optional[TitaniumTitaniumMetadatabaseStatus] = None
    scheduler: Optional[TitaniumTitaniumSchedulerStatus] = None
    triggerer: Optional[TitaniumTitaniumTriggererStatus] = None
    dag_processor: Optional[TitaniumTitaniumDagProcessorStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadatabase": TitaniumTitaniumMetadatabaseStatus.from_dict(obj["metadatabase"]) if obj.get("metadatabase") is not None else None,
            "scheduler": TitaniumTitaniumSchedulerStatus.from_dict(obj["scheduler"]) if obj.get("scheduler") is not None else None,
            "triggerer": TitaniumTitaniumTriggererStatus.from_dict(obj["triggerer"]) if obj.get("triggerer") is not None else None,
            "dag_processor": TitaniumTitaniumDagProcessorStatus.from_dict(obj["dag_processor"]) if obj.get("dag_processor") is not None else None
        })
        return _obj
