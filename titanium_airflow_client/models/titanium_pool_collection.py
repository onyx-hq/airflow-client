...
class TitaniumPoolCollection(BaseModel):
    """
    ...
    pools: Optional[List[TitaniumTitaniumPool]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pools": [TitaniumTitaniumPool.from_dict(_item) for _item in obj["pools"]] if obj.get("pools") is not None else None
        })
        return _obj
