...
class TitaniumConfig(BaseModel):
    """
    The configuration.
    """ # noqa: E501
    sections: Optional[List[TitaniumTitaniumConfigSection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sections": [TitaniumTitaniumConfigSection.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
