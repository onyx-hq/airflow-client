...
class TitaniumRole(BaseModel):
    ...
    actions: Optional[List[TitaniumTitaniumActionResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "actions": [TitaniumTitaniumActionResource.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
