...
class TitaniumDAGCollection(BaseModel):
    """
    ...
    dags: Optional[List[TitaniumTitaniumDAG]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dags": [TitaniumTitaniumDAG.from_dict(_item) for _item in obj["dags"]] if obj.get("dags") is not None else None
        })
        return _obj
