...
class TitaniumDataset(BaseModel):
    """
    ...
    consuming_dags: Optional[List[TitaniumTitaniumDagScheduleDatasetReference]] = None
    producing_tasks: Optional[List[TitaniumTitaniumTaskOutletDatasetReference]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.consuming_dags:
            for _item in self.consuming_dags:
                if _item:
        ...
        if self.producing_tasks:
            for _item in self.producing_tasks:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consuming_dags": [TitaniumTitaniumDagScheduleDatasetReference.from_dict(_item) for _item in obj["consuming_dags"]] if obj.get("consuming_dags") is not None else None,
            "producing_tasks": [TitaniumTitaniumTaskOutletDatasetReference.from_dict(_item) for _item in obj["producing_tasks"]] if obj.get("producing_tasks") is not None else None
        })
        return _obj
