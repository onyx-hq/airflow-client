...
class TitaniumTaskCollection(BaseModel):
    """
    Collection of tasks.
    """ # noqa: E501
    tasks: Optional[List[TitaniumTitaniumTask]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tasks": [TitaniumTitaniumTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
