...
class TitaniumDAGRunCollection(BaseModel):
    """
    ...
    dag_runs: Optional[List[TitaniumTitaniumDAGRun]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dag_runs": [TitaniumTitaniumDAGRun.from_dict(_item) for _item in obj["dag_runs"]] if obj.get("dag_runs") is not None else None
        })
        return _obj
