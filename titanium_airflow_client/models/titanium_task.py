...
class TitaniumTask(BaseModel):
    ...
    """ # noqa: E501
    class_ref: Optional[TitaniumTitaniumClassReference] = None
    task_id: Optional[StrictStr] = None
    task_display_name: Optional[StrictStr] = None
    owner: Optional[StrictStr] = None
    start_date: Optional[datetime] = None
    end_date: Optional[datetime] = None
    trigger_rule: Optional[TitaniumTitaniumTriggerRule] = None
    extra_links: Optional[List[TitaniumTitaniumTaskExtraLinksInner]] = None
    ...
    execution_timeout: Optional[TitaniumTitaniumTimeDelta] = None
    retry_delay: Optional[TitaniumTitaniumTimeDelta] = None
    retry_exponential_backoff: Optional[StrictBool] = None
    priority_weight: Optional[Union[StrictFloat, StrictInt]] = None
    weight_rule: Optional[TitaniumTitaniumWeightRule] = None
    ...
    sub_dag: Optional[TitaniumTitaniumDAG] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "class_ref": TitaniumTitaniumClassReference.from_dict(obj["class_ref"]) if obj.get("class_ref") is not None else None,
            ...
            "extra_links": [TitaniumTitaniumTaskExtraLinksInner.from_dict(_item) for _item in obj["extra_links"]] if obj.get("extra_links") is not None else None,
            ...
            "execution_timeout": TitaniumTitaniumTimeDelta.from_dict(obj["execution_timeout"]) if obj.get("execution_timeout") is not None else None,
            "retry_delay": TitaniumTitaniumTimeDelta.from_dict(obj["retry_delay"]) if obj.get("retry_delay") is not None else None,
            ...
            "sub_dag": TitaniumTitaniumDAG.from_dict(obj["sub_dag"]) if obj.get("sub_dag") is not None else None,
