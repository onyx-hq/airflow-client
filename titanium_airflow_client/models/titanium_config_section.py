...
class TitaniumConfigSection(BaseModel):
    """
    The section of configuration.
    """ # noqa: E501
    name: Optional[StrictStr] = None
    options: Optional[List[TitaniumTitaniumConfigOption]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "options": [TitaniumTitaniumConfigOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
