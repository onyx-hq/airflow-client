...
class TitaniumTaskInstanceCollection(BaseModel):
    """
    ...
    task_instances: Optional[List[TitaniumTitaniumTaskInstance]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task_instances": [TitaniumTitaniumTaskInstance.from_dict(_item) for _item in obj["task_instances"]] if obj.get("task_instances") is not None else None
        })
        return _obj
