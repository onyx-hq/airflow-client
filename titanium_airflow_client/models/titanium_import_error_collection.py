...
class TitaniumImportErrorCollection(BaseModel):
    """
    ...
    import_errors: Optional[List[TitaniumTitaniumImportError]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "import_errors": [TitaniumTitaniumImportError.from_dict(_item) for _item in obj["import_errors"]] if obj.get("import_errors") is not None else None
        })
        return _obj
