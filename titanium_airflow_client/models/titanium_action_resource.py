...
class TitaniumActionResource(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": TitaniumTitaniumAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "resource": TitaniumTitaniumResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None
        })
        return _obj
