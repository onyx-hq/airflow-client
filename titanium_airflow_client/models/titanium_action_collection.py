...
from titanium_airflow_client.models.titanium_titanium_action import TitaniumTitaniumAction
from typing import Optional, Set
from typing_extensions import Self

class TitaniumActionCollection(BaseModel):
    """
    ...
    actions: Optional[List[TitaniumTitaniumAction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actions": [TitaniumTitaniumAction.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
