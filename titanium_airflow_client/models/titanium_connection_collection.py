...
from titanium_airflow_client.models.titanium_titanium_connection_collection_item import TitaniumTitaniumConnectionCollectionItem
from typing import Optional, Set
from typing_extensions import Self

class TitaniumConnectionCollection(BaseModel):
    """
    ...
    connections: Optional[List[TitaniumTitaniumConnectionCollectionItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connections": [TitaniumTitaniumConnectionCollectionItem.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
        return _obj
