...
class TitaniumTaskInstance(BaseModel):
    """
    ...
    state: Optional[TitaniumTitaniumTaskState] = None
    ...
    sla_miss: Optional[TitaniumTitaniumSLAMiss] = None
    ...
    trigger: Optional[TitaniumTitaniumTrigger] = None
    triggerer_job: Optional[TitaniumTitaniumJob] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sla_miss": TitaniumTitaniumSLAMiss.from_dict(obj["sla_miss"]) if obj.get("sla_miss") is not None else None,
            "rendered_map_index": obj.get("rendered_map_index"),
            "rendered_fields": obj.get("rendered_fields"),
            "trigger": TitaniumTitaniumTrigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None,
            "triggerer_job": TitaniumTitaniumJob.from_dict(obj["triggerer_job"]) if obj.get("triggerer_job") is not None else None,
            "note": obj.get("note")
        })
        return _obj
