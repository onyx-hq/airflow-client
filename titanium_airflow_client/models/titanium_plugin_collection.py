...
from titanium_airflow_client.models.titanium_titanium_plugin_collection_item import TitaniumTitaniumPluginCollectionItem
from typing import Optional, Set
from typing_extensions import Self

class TitaniumPluginCollection(BaseModel):
    """
    ...
    plugins: Optional[List[TitaniumTitaniumPluginCollectionItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugins": [TitaniumTitaniumPluginCollectionItem.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None
        })
        return _obj
