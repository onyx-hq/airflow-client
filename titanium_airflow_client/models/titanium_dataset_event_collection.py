...
class TitaniumDatasetEventCollection(BaseModel):
    """
    ...
    dataset_events: Optional[List[TitaniumTitaniumDatasetEvent]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.dataset_events:
            for _item in self.dataset_events:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataset_events": [TitaniumTitaniumDatasetEvent.from_dict(_item) for _item in obj["dataset_events"]] if obj.get("dataset_events") is not None else None
        })
        return _obj
