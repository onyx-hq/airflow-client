...
from titanium_airflow_client.models.titanium_titanium_variable_collection_item import TitaniumTitaniumVariableCollectionItem
from typing import Optional, Set
from typing_extensions import Self

class TitaniumVariableCollection(BaseModel):
    """
    ...
    variables: Optional[List[TitaniumTitaniumVariableCollectionItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "variables": [TitaniumTitaniumVariableCollectionItem.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None
        })
        return _obj
