...
from titanium_airflow_client.models.titanium_titanium_provider import TitaniumTitaniumProvider
from typing import Optional, Set
from typing_extensions import Self

class TitaniumGetProviders200Response(BaseModel):
    """
    TitaniumGetProviders200Response
    """ # noqa: E501
    providers: Optional[List[TitaniumTitaniumProvider]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [TitaniumTitaniumProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None,
