...
class TitaniumQueuedEventCollection(BaseModel):
    """
    ...
    datasets: Optional[List[TitaniumTitaniumQueuedEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datasets": [TitaniumTitaniumQueuedEvent.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
