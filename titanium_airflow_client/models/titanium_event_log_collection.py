...
class TitaniumEventLogCollection(BaseModel):
    """
    ...
    event_logs: Optional[List[TitaniumTitaniumEventLog]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event_logs": [TitaniumTitaniumEventLog.from_dict(_item) for _item in obj["event_logs"]] if obj.get("event_logs") is not None else None
        })
        return _obj
