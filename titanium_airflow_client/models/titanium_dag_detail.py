...
from titanium_airflow_client.models.titanium_titanium_schedule_interval import TitaniumTitaniumScheduleInterval
from titanium_airflow_client.models.titanium_titanium_tag import TitaniumTitaniumTag
from titanium_airflow_client.models.titanium_titanium_time_delta import TitaniumTitaniumTimeDelta
from typing import Optional, Set
from typing_extensions import Self

class TitaniumDAGDetail(BaseModel):
    """
    ...
    schedule_interval: Optional[TitaniumTitaniumScheduleInterval] = None
    ...
    tags: Optional[List[TitaniumTitaniumTag]] = Field(default=None, description="List of tags.")
    ...
    dag_run_timeout: Optional[TitaniumTitaniumTimeDelta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule_interval": TitaniumTitaniumScheduleInterval.from_dict(obj["schedule_interval"]) if obj.get("schedule_interval") is not None else None,
            "timetable_description": obj.get("timetable_description"),
            "tags": [TitaniumTitaniumTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
            ...
            "dag_run_timeout": TitaniumTitaniumTimeDelta.from_dict(obj["dag_run_timeout"]) if obj.get("dag_run_timeout") is not None else None,
