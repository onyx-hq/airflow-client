...
class TitaniumRoleCollection(BaseModel):
    """
    ...
    roles: Optional[List[TitaniumTitaniumRole]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roles": [TitaniumTitaniumRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
