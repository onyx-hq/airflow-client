...
class TitaniumDatasetCollection(BaseModel):
    """
    ...
    datasets: Optional[List[TitaniumTitaniumDataset]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datasets": [TitaniumTitaniumDataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
