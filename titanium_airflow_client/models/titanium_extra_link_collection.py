...
class TitaniumExtraLinkCollection(BaseModel):
    """
    The collection of extra links.
    """ # noqa: E501
    extra_links: Optional[List[TitaniumTitaniumExtraLink]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extra_links": [TitaniumTitaniumExtraLink.from_dict(_item) for _item in obj["extra_links"]] if obj.get("extra_links") is not None else None
        })
        return _obj
