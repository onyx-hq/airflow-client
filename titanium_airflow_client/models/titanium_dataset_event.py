...
class TitaniumDatasetEvent(BaseModel):
    """
    ...
    created_dagruns: Optional[List[TitaniumTitaniumBasicDAGRun]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.created_dagruns:
            for _item in self.created_dagruns:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "created_dagruns": [TitaniumTitaniumBasicDAGRun.from_dict(_item) for _item in obj["created_dagruns"]] if obj.get("created_dagruns") is not None else None,
