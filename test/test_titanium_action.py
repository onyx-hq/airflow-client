...
class TestTitaniumAction(unittest.TestCase):
    """TitaniumAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumAction:
        """Test TitaniumAction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumAction`
        """
        model = TitaniumAction()
        if include_optional:
            return TitaniumAction(
                name = ''
            )
        else:
            return TitaniumAction(
