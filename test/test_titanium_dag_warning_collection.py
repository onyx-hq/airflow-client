...
class TestTitaniumDagWarningCollection(unittest.TestCase):
    """TitaniumDagWarningCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDagWarningCollection:
        """Test TitaniumDagWarningCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDagWarningCollection`
        """
        model = TitaniumDagWarningCollection()
        if include_optional:
            return TitaniumDagWarningCollection(
                total_entries = 56,
                import_errors = [
                    titanium_airflow_client.models.dag_warning.DagWarning(
                        dag_id = '', 
                        warning_type = '', 
                        message = '', 
                        timestamp = '', )
    ...
    def testTitaniumDagWarningCollection(self):
        """Test TitaniumDagWarningCollection"""
