...
class TestTitaniumClearDagRun200Response(unittest.TestCase):
    """TitaniumClearDagRun200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumClearDagRun200Response:
        """Test TitaniumClearDagRun200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumClearDagRun200Response`
        """
        model = TitaniumClearDagRun200Response()
        if include_optional:
            return TitaniumClearDagRun200Response(
                dag_run_id = '',
                dag_id = '',
                ...
                conf = titanium_airflow_client.models.conf.conf(),
                note = '',
    ...
    def testTitaniumClearDagRun200Response(self):
        """Test TitaniumClearDagRun200Response"""
