...
class TestTitaniumTrigger(unittest.TestCase):
    """TitaniumTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTrigger:
        """Test TitaniumTrigger
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTrigger`
        """
        model = TitaniumTrigger()
        if include_optional:
            return TitaniumTrigger(
                id = 56,
                classpath = '',
                kwargs = '',
                created_date = '',
