...
class TestTitaniumQueuedEventCollection(unittest.TestCase):
    """TitaniumQueuedEventCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumQueuedEventCollection:
        """Test TitaniumQueuedEventCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumQueuedEventCollection`
        """
        model = TitaniumQueuedEventCollection()
        if include_optional:
            return TitaniumQueuedEventCollection(
                total_entries = 56,
                datasets = [
                    titanium_airflow_client.models.queued_event.QueuedEvent(
                        uri = '', 
                        dag_id = '', 
    ...
    def testTitaniumQueuedEventCollection(self):
        """Test TitaniumQueuedEventCollection"""
