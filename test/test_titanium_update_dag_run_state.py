...
class TestTitaniumUpdateDagRunState(unittest.TestCase):
    """TitaniumUpdateDagRunState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumUpdateDagRunState:
        """Test TitaniumUpdateDagRunState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumUpdateDagRunState`
        """
        model = TitaniumUpdateDagRunState()
        if include_optional:
            return TitaniumUpdateDagRunState(
                state = 'success'
            )
        else:
            return TitaniumUpdateDagRunState(
    ...
    def testTitaniumUpdateDagRunState(self):
        """Test TitaniumUpdateDagRunState"""
