...
class TestTitaniumDatasetCollection(unittest.TestCase):
    """TitaniumDatasetCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDatasetCollection:
        """Test TitaniumDatasetCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDatasetCollection`
        """
        model = TitaniumDatasetCollection()
        if include_optional:
            return TitaniumDatasetCollection(
                total_entries = 56,
                datasets = [
                    titanium_airflow_client.models.dataset.Dataset(
                        id = 56, 
                        uri = '', 
                        extra = titanium_airflow_client.models.extra.extra(), 
                        created_at = '', 
                        updated_at = '', 
                        consuming_dags = [
                            titanium_airflow_client.models.dag_schedule_dataset_reference.DagScheduleDatasetReference(
                                dag_id = '', 
                                created_at = '', 
                                updated_at = '', )
                            ], 
                        producing_tasks = [
                            titanium_airflow_client.models.task_outlet_dataset_reference.TaskOutletDatasetReference(
                                dag_id = '', 
                                task_id = '', 
                                created_at = '', 
                                updated_at = '', )
    ...
    def testTitaniumDatasetCollection(self):
        """Test TitaniumDatasetCollection"""
