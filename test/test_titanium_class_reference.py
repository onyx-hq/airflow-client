...
class TestTitaniumClassReference(unittest.TestCase):
    """TitaniumClassReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumClassReference:
        """Test TitaniumClassReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumClassReference`
        """
        model = TitaniumClassReference()
        if include_optional:
            return TitaniumClassReference(
                module_path = '',
                class_name = ''
            )
        else:
    ...
    def testTitaniumClassReference(self):
        """Test TitaniumClassReference"""
