...
class TestTitaniumUpdateTaskInstance(unittest.TestCase):
    """TitaniumUpdateTaskInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumUpdateTaskInstance:
        """Test TitaniumUpdateTaskInstance
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumUpdateTaskInstance`
        """
        model = TitaniumUpdateTaskInstance()
        if include_optional:
            return TitaniumUpdateTaskInstance(
                dry_run = True,
                new_state = 'success'
            )
        else:
    ...
    def testTitaniumUpdateTaskInstance(self):
        """Test TitaniumUpdateTaskInstance"""
