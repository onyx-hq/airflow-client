...
class TestTitaniumImportError(unittest.TestCase):
    """TitaniumImportError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumImportError:
        """Test TitaniumImportError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumImportError`
        """
        model = TitaniumImportError()
        if include_optional:
            return TitaniumImportError(
                import_error_id = 56,
                timestamp = '',
                filename = '',
                stack_trace = ''
    ...
    def testTitaniumImportError(self):
        """Test TitaniumImportError"""
