...
class TestTitaniumVariableCollection(unittest.TestCase):
    """TitaniumVariableCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumVariableCollection:
        """Test TitaniumVariableCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumVariableCollection`
        """
        model = TitaniumVariableCollection()
        if include_optional:
            return TitaniumVariableCollection(
                total_entries = 56,
                variables = [
                    titanium_airflow_client.models.variable_collection_item.VariableCollectionItem(
                        key = '', 
                        description = '', )
                    ]
            )
    ...
    def testTitaniumVariableCollection(self):
        """Test TitaniumVariableCollection"""
