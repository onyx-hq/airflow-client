...
class TestTitaniumTaskInstance(unittest.TestCase):
    """TitaniumTaskInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskInstance:
        """Test TitaniumTaskInstance
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskInstance`
        """
        model = TitaniumTaskInstance()
        if include_optional:
            return TitaniumTaskInstance(
                task_id = '',
                task_display_name = '',
                dag_id = '',
                dag_run_id = '',
                ...
                pid = 56,
                executor_config = '',
                sla_miss = titanium_airflow_client.models.sla_miss.SLAMiss(
                    task_id = '', 
                    dag_id = '', 
                    execution_date = '', 
                    email_sent = True, 
                ...
                trigger = titanium_airflow_client.models.trigger.Trigger(
                    id = 56, 
                    classpath = '', 
                    kwargs = '', 
                    created_date = '', 
                    triggerer_id = 56, ),
                triggerer_job = titanium_airflow_client.models.job.Job(
                    id = 56, 
                    dag_id = '', 
                    state = '', 
                    job_type = '', 
    ...
    def testTitaniumTaskInstance(self):
        """Test TitaniumTaskInstance"""
