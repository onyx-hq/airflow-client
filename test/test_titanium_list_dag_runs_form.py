...
class TestTitaniumListDagRunsForm(unittest.TestCase):
    """TitaniumListDagRunsForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumListDagRunsForm:
        """Test TitaniumListDagRunsForm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumListDagRunsForm`
        """
        model = TitaniumListDagRunsForm()
        if include_optional:
            return TitaniumListDagRunsForm(
                order_by = '',
                page_offset = 0,
                page_limit = 1,
                dag_ids = [
    ...
    def testTitaniumListDagRunsForm(self):
        """Test TitaniumListDagRunsForm"""
