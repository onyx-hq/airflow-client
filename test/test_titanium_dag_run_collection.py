...
class TestTitaniumDAGRunCollection(unittest.TestCase):
    """TitaniumDAGRunCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDAGRunCollection:
        """Test TitaniumDAGRunCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDAGRunCollection`
        """
        model = TitaniumDAGRunCollection()
        if include_optional:
            return TitaniumDAGRunCollection(
                total_entries = 56,
                dag_runs = [
                    titanium_airflow_client.models.dag_run.DAGRun(
                        dag_run_id = '', 
                        dag_id = '', 
    ...
    def testTitaniumDAGRunCollection(self):
        """Test TitaniumDAGRunCollection"""
