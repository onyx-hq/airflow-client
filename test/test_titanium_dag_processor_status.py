...
class TestTitaniumDagProcessorStatus(unittest.TestCase):
    """TitaniumDagProcessorStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDagProcessorStatus:
        """Test TitaniumDagProcessorStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDagProcessorStatus`
        """
        model = TitaniumDagProcessorStatus()
        if include_optional:
            return TitaniumDagProcessorStatus(
                status = 'healthy',
    ...
    def testTitaniumDagProcessorStatus(self):
        """Test TitaniumDagProcessorStatus"""
