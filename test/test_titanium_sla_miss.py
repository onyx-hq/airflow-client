...
class TestTitaniumSLAMiss(unittest.TestCase):
    """TitaniumSLAMiss unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumSLAMiss:
        """Test TitaniumSLAMiss
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumSLAMiss`
        """
        model = TitaniumSLAMiss()
        if include_optional:
            return TitaniumSLAMiss(
                task_id = '',
                dag_id = '',
                execution_date = '',
                email_sent = True,
