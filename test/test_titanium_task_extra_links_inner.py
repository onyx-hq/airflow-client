...
class TestTitaniumTaskExtraLinksInner(unittest.TestCase):
    """TitaniumTaskExtraLinksInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskExtraLinksInner:
        """Test TitaniumTaskExtraLinksInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskExtraLinksInner`
        """
        model = TitaniumTaskExtraLinksInner()
        if include_optional:
            return TitaniumTaskExtraLinksInner(
    ...
    def testTitaniumTaskExtraLinksInner(self):
        """Test TitaniumTaskExtraLinksInner"""
