...
class TestTitaniumGetProviders200Response(unittest.TestCase):
    """TitaniumGetProviders200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumGetProviders200Response:
        """Test TitaniumGetProviders200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumGetProviders200Response`
        """
        model = TitaniumGetProviders200Response()
        if include_optional:
            return TitaniumGetProviders200Response(
                providers = [
                    titanium_airflow_client.models.provider.Provider(
                        package_name = '', 
                        description = '', 
                        version = '', )
                    ],
    ...
    def testTitaniumGetProviders200Response(self):
        """Test TitaniumGetProviders200Response"""
