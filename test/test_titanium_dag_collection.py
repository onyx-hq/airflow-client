...
class TestTitaniumDAGCollection(unittest.TestCase):
    """TitaniumDAGCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDAGCollection:
        """Test TitaniumDAGCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDAGCollection`
        """
        model = TitaniumDAGCollection()
        if include_optional:
            return TitaniumDAGCollection(
                total_entries = 56,
                dags = [
                    titanium_airflow_client.models.dag.DAG(
                        dag_id = '', 
                        dag_display_name = '', 
                        root_dag_id = '', 
                        is_paused = True, 
    ...
    def testTitaniumDAGCollection(self):
        """Test TitaniumDAGCollection"""
