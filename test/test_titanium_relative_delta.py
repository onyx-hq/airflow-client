...
class TestTitaniumRelativeDelta(unittest.TestCase):
    """TitaniumRelativeDelta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumRelativeDelta:
        """Test TitaniumRelativeDelta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumRelativeDelta`
        """
        model = TitaniumRelativeDelta()
        if include_optional:
            return TitaniumRelativeDelta(
                type = '',
                years = 56,
                months = 56,
                days = 56,
    ...
    def testTitaniumRelativeDelta(self):
        """Test TitaniumRelativeDelta"""
