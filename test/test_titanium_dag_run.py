...
class TestTitaniumDAGRun(unittest.TestCase):
    """TitaniumDAGRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDAGRun:
        """Test TitaniumDAGRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDAGRun`
        """
        model = TitaniumDAGRun()
        if include_optional:
            return TitaniumDAGRun(
                dag_run_id = '',
                dag_id = '',
