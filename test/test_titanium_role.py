...
class TestTitaniumRole(unittest.TestCase):
    """TitaniumRole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumRole:
        """Test TitaniumRole
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumRole`
        """
        model = TitaniumRole()
        if include_optional:
            return TitaniumRole(
