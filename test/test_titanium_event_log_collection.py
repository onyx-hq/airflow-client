...
class TestTitaniumEventLogCollection(unittest.TestCase):
    """TitaniumEventLogCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumEventLogCollection:
        """Test TitaniumEventLogCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumEventLogCollection`
        """
        model = TitaniumEventLogCollection()
        if include_optional:
            return TitaniumEventLogCollection(
                total_entries = 56,
                event_logs = [
                    titanium_airflow_client.models.event_log.EventLog(
                        event_log_id = 56, 
    ...
    def testTitaniumEventLogCollection(self):
        """Test TitaniumEventLogCollection"""
