...
class TestTitaniumUpdateTaskInstancesState(unittest.TestCase):
    """TitaniumUpdateTaskInstancesState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumUpdateTaskInstancesState:
        """Test TitaniumUpdateTaskInstancesState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumUpdateTaskInstancesState`
        """
        model = TitaniumUpdateTaskInstancesState()
        if include_optional:
            return TitaniumUpdateTaskInstancesState(
                dry_run = True,
                task_id = '',
                execution_date = '',
                dag_run_id = '',
    ...
    def testTitaniumUpdateTaskInstancesState(self):
        """Test TitaniumUpdateTaskInstancesState"""
