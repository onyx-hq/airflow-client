...
class TestTitaniumDataset(unittest.TestCase):
    """TitaniumDataset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDataset:
        """Test TitaniumDataset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDataset`
        """
        model = TitaniumDataset()
        if include_optional:
            return TitaniumDataset(
                id = 56,
                uri = '',
                extra = None,
                created_at = '',
