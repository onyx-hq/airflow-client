...
class TestTitaniumProviderCollection(unittest.TestCase):
    """TitaniumProviderCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumProviderCollection:
        """Test TitaniumProviderCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumProviderCollection`
        """
        model = TitaniumProviderCollection()
        if include_optional:
            return TitaniumProviderCollection(
                providers = [
    ...
    def testTitaniumProviderCollection(self):
        """Test TitaniumProviderCollection"""
