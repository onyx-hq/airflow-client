...
class TestTitaniumCollectionInfo(unittest.TestCase):
    """TitaniumCollectionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumCollectionInfo:
        """Test TitaniumCollectionInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumCollectionInfo`
        """
        model = TitaniumCollectionInfo()
        if include_optional:
            return TitaniumCollectionInfo(
                total_entries = 56
            )
        else:
            return TitaniumCollectionInfo(
    ...
    def testTitaniumCollectionInfo(self):
        """Test TitaniumCollectionInfo"""
