...
class TestTitaniumTaskCollection(unittest.TestCase):
    """TitaniumTaskCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskCollection:
        """Test TitaniumTaskCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskCollection`
        """
        model = TitaniumTaskCollection()
        if include_optional:
            return TitaniumTaskCollection(
                tasks = [
                    titanium_airflow_client.models.task.Task(
                        class_ref = titanium_airflow_client.models.class_reference.ClassReference(
                            module_path = '', 
                            class_name = '', ), 
                        task_id = '', 
                        task_display_name = '', 
                        ...
                        extra_links = [
                            titanium_airflow_client.models.task_extra_links_inner.Task_extra_links_inner()
                            ], 
                        ...
                        pool = '', 
                        pool_slots = 1.337, 
                        execution_timeout = titanium_airflow_client.models.time_delta.TimeDelta(
                            __type = '', 
                            days = 56, 
                            seconds = 56, 
                            microseconds = 56, ), 
                        retry_delay = titanium_airflow_client.models.time_delta.TimeDelta(
                            __type = '', 
                            days = 56, 
                            seconds = 56, 
                            microseconds = 56, ), 
                        ...
                        sub_dag = titanium_airflow_client.models.dag.DAG(
                            dag_id = '', 
                            dag_display_name = '', 
                            root_dag_id = '', 
                            is_paused = True, 
                            ...
                            tags = [
                                titanium_airflow_client.models.tag.Tag(
                                    name = '', )
                                ], 
                            max_active_tasks = 56, 
                            max_active_runs = 56, 
    ...
    def testTitaniumTaskCollection(self):
        """Test TitaniumTaskCollection"""
