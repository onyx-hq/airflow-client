...
class TestTitaniumImportErrorCollection(unittest.TestCase):
    """TitaniumImportErrorCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumImportErrorCollection:
        """Test TitaniumImportErrorCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumImportErrorCollection`
        """
        model = TitaniumImportErrorCollection()
        if include_optional:
            return TitaniumImportErrorCollection(
                total_entries = 56,
                import_errors = [
                    titanium_airflow_client.models.import_error.ImportError(
                        import_error_id = 56, 
                        timestamp = '', 
                        filename = '', 
                        stack_trace = '', )
    ...
    def testTitaniumImportErrorCollection(self):
        """Test TitaniumImportErrorCollection"""
