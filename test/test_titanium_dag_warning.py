...
class TestTitaniumDagWarning(unittest.TestCase):
    """TitaniumDagWarning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDagWarning:
        """Test TitaniumDagWarning
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDagWarning`
        """
        model = TitaniumDagWarning()
        if include_optional:
            return TitaniumDagWarning(
                dag_id = '',
                warning_type = '',
                message = '',
                timestamp = ''
    ...
    def testTitaniumDagWarning(self):
        """Test TitaniumDagWarning"""
