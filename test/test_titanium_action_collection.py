...
class TestTitaniumActionCollection(unittest.TestCase):
    """TitaniumActionCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumActionCollection:
        """Test TitaniumActionCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumActionCollection`
        """
        model = TitaniumActionCollection()
        if include_optional:
            return TitaniumActionCollection(
                total_entries = 56,
                actions = [
                    titanium_airflow_client.models.action.Action(
                        name = '', )
                    ]
            )
        else:
    ...
    def testTitaniumActionCollection(self):
        """Test TitaniumActionCollection"""
