...
class TestTitaniumEventLog(unittest.TestCase):
    """TitaniumEventLog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumEventLog:
        """Test TitaniumEventLog
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumEventLog`
        """
        model = TitaniumEventLog()
        if include_optional:
            return TitaniumEventLog(
                event_log_id = 56,
