...
class TestTitaniumCronExpression(unittest.TestCase):
    """TitaniumCronExpression unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumCronExpression:
        """Test TitaniumCronExpression
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumCronExpression`
        """
        model = TitaniumCronExpression()
        if include_optional:
            return TitaniumCronExpression(
                type = '',
                value = ''
            )
        else:
    ...
    def testTitaniumCronExpression(self):
        """Test TitaniumCronExpression"""
