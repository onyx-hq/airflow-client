...
class TestTitaniumListTaskInstanceForm(unittest.TestCase):
    """TitaniumListTaskInstanceForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumListTaskInstanceForm:
        """Test TitaniumListTaskInstanceForm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumListTaskInstanceForm`
        """
        model = TitaniumListTaskInstanceForm()
        if include_optional:
            return TitaniumListTaskInstanceForm(
                dag_ids = [
                    ''
                    ],
                dag_run_ids = [
    ...
    def testTitaniumListTaskInstanceForm(self):
        """Test TitaniumListTaskInstanceForm"""
