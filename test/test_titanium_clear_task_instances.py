...
class TestTitaniumClearTaskInstances(unittest.TestCase):
    """TitaniumClearTaskInstances unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumClearTaskInstances:
        """Test TitaniumClearTaskInstances
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumClearTaskInstances`
        """
        model = TitaniumClearTaskInstances()
        if include_optional:
            return TitaniumClearTaskInstances(
                dry_run = True,
                task_ids = [
                    ''
                    ],
    ...
    def testTitaniumClearTaskInstances(self):
        """Test TitaniumClearTaskInstances"""
