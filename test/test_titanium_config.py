...
class TestTitaniumConfig(unittest.TestCase):
    """TitaniumConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConfig:
        """Test TitaniumConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConfig`
        """
        model = TitaniumConfig()
        if include_optional:
            return TitaniumConfig(
                sections = [
                    titanium_airflow_client.models.config_section.ConfigSection(
                        name = '', 
                        options = [
