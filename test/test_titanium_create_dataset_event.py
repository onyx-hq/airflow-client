...
class TestTitaniumCreateDatasetEvent(unittest.TestCase):
    """TitaniumCreateDatasetEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumCreateDatasetEvent:
        """Test TitaniumCreateDatasetEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumCreateDatasetEvent`
        """
        model = TitaniumCreateDatasetEvent()
        if include_optional:
            return TitaniumCreateDatasetEvent(
                dataset_uri = '',
                extra = None
            )
        else:
    ...
    def testTitaniumCreateDatasetEvent(self):
        """Test TitaniumCreateDatasetEvent"""
