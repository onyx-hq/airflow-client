...
class TestTitaniumExtraLinkCollection(unittest.TestCase):
    """TitaniumExtraLinkCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumExtraLinkCollection:
        """Test TitaniumExtraLinkCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumExtraLinkCollection`
        """
        model = TitaniumExtraLinkCollection()
        if include_optional:
            return TitaniumExtraLinkCollection(
                extra_links = [
                    titanium_airflow_client.models.extra_link.ExtraLink(
    ...
    def testTitaniumExtraLinkCollection(self):
        """Test TitaniumExtraLinkCollection"""
