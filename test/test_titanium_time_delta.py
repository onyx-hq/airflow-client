...
class TestTitaniumTimeDelta(unittest.TestCase):
    """TitaniumTimeDelta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTimeDelta:
        """Test TitaniumTimeDelta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTimeDelta`
        """
        model = TitaniumTimeDelta()
        if include_optional:
            return TitaniumTimeDelta(
                type = '',
                days = 56,
                seconds = 56,
                microseconds = 56
    ...
    def testTitaniumTimeDelta(self):
        """Test TitaniumTimeDelta"""
