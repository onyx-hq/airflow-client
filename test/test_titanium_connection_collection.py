...
class TestTitaniumConnectionCollection(unittest.TestCase):
    """TitaniumConnectionCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConnectionCollection:
        """Test TitaniumConnectionCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConnectionCollection`
        """
        model = TitaniumConnectionCollection()
        if include_optional:
            return TitaniumConnectionCollection(
                total_entries = 56,
                connections = [
                    titanium_airflow_client.models.connection_collection_item.ConnectionCollectionItem(
                        connection_id = '', 
                        conn_type = '', 
                        description = '', 
                        host = '', 
    ...
    def testTitaniumConnectionCollection(self):
        """Test TitaniumConnectionCollection"""
