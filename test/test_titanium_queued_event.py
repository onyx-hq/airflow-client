...
class TestTitaniumQueuedEvent(unittest.TestCase):
    """TitaniumQueuedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumQueuedEvent:
        """Test TitaniumQueuedEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumQueuedEvent`
        """
        model = TitaniumQueuedEvent()
        if include_optional:
            return TitaniumQueuedEvent(
                uri = '',
                dag_id = '',
    ...
    def testTitaniumQueuedEvent(self):
        """Test TitaniumQueuedEvent"""
