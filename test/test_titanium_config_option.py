...
class TestTitaniumConfigOption(unittest.TestCase):
    """TitaniumConfigOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConfigOption:
        """Test TitaniumConfigOption
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConfigOption`
        """
        model = TitaniumConfigOption()
        if include_optional:
            return TitaniumConfigOption(
                key = '',
                value = ''
            )
        else:
    ...
    def testTitaniumConfigOption(self):
        """Test TitaniumConfigOption"""
