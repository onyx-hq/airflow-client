...
class TestTitaniumVariableCollectionItem(unittest.TestCase):
    """TitaniumVariableCollectionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumVariableCollectionItem:
        """Test TitaniumVariableCollectionItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumVariableCollectionItem`
        """
        model = TitaniumVariableCollectionItem()
        if include_optional:
            return TitaniumVariableCollectionItem(
                key = '',
                description = ''
            )
        else:
    ...
    def testTitaniumVariableCollectionItem(self):
        """Test TitaniumVariableCollectionItem"""
