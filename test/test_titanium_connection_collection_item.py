...
class TestTitaniumConnectionCollectionItem(unittest.TestCase):
    """TitaniumConnectionCollectionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConnectionCollectionItem:
        """Test TitaniumConnectionCollectionItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConnectionCollectionItem`
        """
        model = TitaniumConnectionCollectionItem()
        if include_optional:
            return TitaniumConnectionCollectionItem(
                connection_id = '',
                conn_type = '',
                description = '',
                host = '',
    ...
    def testTitaniumConnectionCollectionItem(self):
        """Test TitaniumConnectionCollectionItem"""
