...
class TestTitaniumDAG(unittest.TestCase):
    """TitaniumDAG unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDAG:
        """Test TitaniumDAG
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDAG`
        """
        model = TitaniumDAG()
        if include_optional:
            return TitaniumDAG(
