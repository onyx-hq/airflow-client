...
class TestTitaniumTriggererStatus(unittest.TestCase):
    """TitaniumTriggererStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTriggererStatus:
        """Test TitaniumTriggererStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTriggererStatus`
        """
        model = TitaniumTriggererStatus()
        if include_optional:
            return TitaniumTriggererStatus(
                status = 'healthy',
    ...
    def testTitaniumTriggererStatus(self):
        """Test TitaniumTriggererStatus"""
