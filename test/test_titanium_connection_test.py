...
class TestTitaniumConnectionTest(unittest.TestCase):
    """TitaniumConnectionTest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConnectionTest:
        """Test TitaniumConnectionTest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConnectionTest`
        """
        model = TitaniumConnectionTest()
        if include_optional:
            return TitaniumConnectionTest(
                status = True,
                message = ''
            )
        else:
    ...
    def testTitaniumConnectionTest(self):
        """Test TitaniumConnectionTest"""
