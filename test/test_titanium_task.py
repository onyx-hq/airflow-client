...
class TestTitaniumTask(unittest.TestCase):
    """TitaniumTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTask:
        """Test TitaniumTask
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTask`
        """
        model = TitaniumTask()
        if include_optional:
            return TitaniumTask(
