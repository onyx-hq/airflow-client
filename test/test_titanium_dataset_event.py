...
class TestTitaniumDatasetEvent(unittest.TestCase):
    """TitaniumDatasetEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDatasetEvent:
        """Test TitaniumDatasetEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDatasetEvent`
        """
        model = TitaniumDatasetEvent()
        if include_optional:
            return TitaniumDatasetEvent(
                dataset_id = 56,
                dataset_uri = '',
                extra = None,
                source_dag_id = '',
    ...
    def testTitaniumDatasetEvent(self):
        """Test TitaniumDatasetEvent"""
