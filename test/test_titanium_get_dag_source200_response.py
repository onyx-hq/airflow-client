...
class TestTitaniumGetDagSource200Response(unittest.TestCase):
    """TitaniumGetDagSource200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumGetDagSource200Response:
        """Test TitaniumGetDagSource200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumGetDagSource200Response`
        """
        model = TitaniumGetDagSource200Response()
        if include_optional:
            return TitaniumGetDagSource200Response(
                content = ''
            )
        else:
            return TitaniumGetDagSource200Response(
    ...
    def testTitaniumGetDagSource200Response(self):
        """Test TitaniumGetDagSource200Response"""
