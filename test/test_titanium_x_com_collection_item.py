...
class TestTitaniumXComCollectionItem(unittest.TestCase):
    """TitaniumXComCollectionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumXComCollectionItem:
        """Test TitaniumXComCollectionItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumXComCollectionItem`
        """
        model = TitaniumXComCollectionItem()
        if include_optional:
            return TitaniumXComCollectionItem(
                key = '',
                timestamp = '',
                execution_date = '',
                map_index = 56,
    ...
    def testTitaniumXComCollectionItem(self):
        """Test TitaniumXComCollectionItem"""
