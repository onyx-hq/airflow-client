...
class TestTitaniumUserCollection(unittest.TestCase):
    """TitaniumUserCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumUserCollection:
        """Test TitaniumUserCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumUserCollection`
        """
        model = TitaniumUserCollection()
        if include_optional:
            return TitaniumUserCollection(
                total_entries = 56,
                users = [
                    titanium_airflow_client.models.user_collection_item.UserCollectionItem(
                        first_name = '', 
                        last_name = '', 
                        username = '0', 
                        email = '0', 
                        ...
                        roles = [
                            titanium_airflow_client.models.user_collection_item_roles_inner.UserCollectionItem_roles_inner(
                                name = '', )
                            ], 
                        created_on = '', 
                        changed_on = '', )
    ...
    def testTitaniumUserCollection(self):
        """Test TitaniumUserCollection"""
