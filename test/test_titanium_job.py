...
class TestTitaniumJob(unittest.TestCase):
    """TitaniumJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumJob:
        """Test TitaniumJob
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumJob`
        """
        model = TitaniumJob()
        if include_optional:
            return TitaniumJob(
