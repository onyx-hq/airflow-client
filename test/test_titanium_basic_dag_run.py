...
class TestTitaniumBasicDAGRun(unittest.TestCase):
    """TitaniumBasicDAGRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumBasicDAGRun:
        """Test TitaniumBasicDAGRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumBasicDAGRun`
        """
        model = TitaniumBasicDAGRun()
        if include_optional:
            return TitaniumBasicDAGRun(
                run_id = '',
                dag_id = '',
    ...
    def testTitaniumBasicDAGRun(self):
        """Test TitaniumBasicDAGRun"""
