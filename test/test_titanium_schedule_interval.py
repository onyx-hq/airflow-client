...
class TestTitaniumScheduleInterval(unittest.TestCase):
    """TitaniumScheduleInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumScheduleInterval:
        """Test TitaniumScheduleInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumScheduleInterval`
        """
        model = TitaniumScheduleInterval()
        if include_optional:
            return TitaniumScheduleInterval(
                type = '',
                days = 56,
                seconds = 56,
                microseconds = 56,
    ...
    def testTitaniumScheduleInterval(self):
        """Test TitaniumScheduleInterval"""
