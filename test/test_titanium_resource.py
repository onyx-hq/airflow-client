...
class TestTitaniumResource(unittest.TestCase):
    """TitaniumResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumResource:
        """Test TitaniumResource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumResource`
        """
        model = TitaniumResource()
        if include_optional:
            return TitaniumResource(
                name = ''
            )
        else:
            return TitaniumResource(
