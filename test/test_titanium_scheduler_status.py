...
class TestTitaniumSchedulerStatus(unittest.TestCase):
    """TitaniumSchedulerStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumSchedulerStatus:
        """Test TitaniumSchedulerStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumSchedulerStatus`
        """
        model = TitaniumSchedulerStatus()
        if include_optional:
            return TitaniumSchedulerStatus(
                status = 'healthy',
    ...
    def testTitaniumSchedulerStatus(self):
        """Test TitaniumSchedulerStatus"""
