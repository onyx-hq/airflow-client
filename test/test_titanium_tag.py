...
class TestTitaniumTag(unittest.TestCase):
    """TitaniumTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTag:
        """Test TitaniumTag
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTag`
        """
        model = TitaniumTag()
        if include_optional:
            return TitaniumTag(
