...
class TestTitaniumXCom(unittest.TestCase):
    """TitaniumXCom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumXCom:
        """Test TitaniumXCom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumXCom`
        """
        model = TitaniumXCom()
        if include_optional:
            return TitaniumXCom(
