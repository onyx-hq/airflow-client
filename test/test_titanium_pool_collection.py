...
class TestTitaniumPoolCollection(unittest.TestCase):
    """TitaniumPoolCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumPoolCollection:
        """Test TitaniumPoolCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumPoolCollection`
        """
        model = TitaniumPoolCollection()
        if include_optional:
            return TitaniumPoolCollection(
                total_entries = 56,
                pools = [
                    titanium_airflow_client.models.pool.Pool(
                        name = '', 
                        slots = 56, 
                        occupied_slots = 56, 
                        running_slots = 56, 
    ...
    def testTitaniumPoolCollection(self):
        """Test TitaniumPoolCollection"""
