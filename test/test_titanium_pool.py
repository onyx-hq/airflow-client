...
class TestTitaniumPool(unittest.TestCase):
    """TitaniumPool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumPool:
        """Test TitaniumPool
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumPool`
        """
        model = TitaniumPool()
        if include_optional:
            return TitaniumPool(
