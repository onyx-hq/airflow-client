...
class TestTitaniumDagScheduleDatasetReference(unittest.TestCase):
    """TitaniumDagScheduleDatasetReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDagScheduleDatasetReference:
        """Test TitaniumDagScheduleDatasetReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDagScheduleDatasetReference`
        """
        model = TitaniumDagScheduleDatasetReference()
        if include_optional:
            return TitaniumDagScheduleDatasetReference(
                dag_id = '',
                created_at = '',
                updated_at = ''
            )
    ...
    def testTitaniumDagScheduleDatasetReference(self):
        """Test TitaniumDagScheduleDatasetReference"""
