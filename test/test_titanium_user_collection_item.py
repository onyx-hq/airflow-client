...
class TestTitaniumUserCollectionItem(unittest.TestCase):
    """TitaniumUserCollectionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumUserCollectionItem:
        """Test TitaniumUserCollectionItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumUserCollectionItem`
        """
        model = TitaniumUserCollectionItem()
        if include_optional:
            return TitaniumUserCollectionItem(
                first_name = '',
                last_name = '',
                username = '0',
                email = '0',
    ...
    def testTitaniumUserCollectionItem(self):
        """Test TitaniumUserCollectionItem"""
