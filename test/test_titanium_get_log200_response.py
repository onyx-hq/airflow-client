...
class TestTitaniumGetLog200Response(unittest.TestCase):
    """TitaniumGetLog200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumGetLog200Response:
        """Test TitaniumGetLog200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumGetLog200Response`
        """
        model = TitaniumGetLog200Response()
        if include_optional:
            return TitaniumGetLog200Response(
                continuation_token = '',
                content = ''
            )
        else:
    ...
    def testTitaniumGetLog200Response(self):
        """Test TitaniumGetLog200Response"""
