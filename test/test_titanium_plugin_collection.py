...
class TestTitaniumPluginCollection(unittest.TestCase):
    """TitaniumPluginCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumPluginCollection:
        """Test TitaniumPluginCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumPluginCollection`
        """
        model = TitaniumPluginCollection()
        if include_optional:
            return TitaniumPluginCollection(
                total_entries = 56,
                plugins = [
                    titanium_airflow_client.models.plugin_collection_item.PluginCollectionItem(
                        name = '', 
                        hooks = [
                            ''
                            ], 
    ...
    def testTitaniumPluginCollection(self):
        """Test TitaniumPluginCollection"""
