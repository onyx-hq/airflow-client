...
class TestTitaniumDAGDetail(unittest.TestCase):
    """TitaniumDAGDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDAGDetail:
        """Test TitaniumDAGDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDAGDetail`
        """
        model = TitaniumDAGDetail()
        if include_optional:
            return TitaniumDAGDetail(
                dag_id = '',
                dag_display_name = '',
                root_dag_id = '',
                is_paused = True,
                ...
                dag_run_timeout = titanium_airflow_client.models.time_delta.TimeDelta(
                    __type = '', 
                    days = 56, 
                    seconds = 56, 
                    microseconds = 56, ),
    ...
    def testTitaniumDAGDetail(self):
        """Test TitaniumDAGDetail"""
