...
class TestTitaniumVersionInfo(unittest.TestCase):
    """TitaniumVersionInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumVersionInfo:
        """Test TitaniumVersionInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumVersionInfo`
        """
        model = TitaniumVersionInfo()
        if include_optional:
            return TitaniumVersionInfo(
                version = '',
                git_version = ''
            )
        else:
    ...
    def testTitaniumVersionInfo(self):
        """Test TitaniumVersionInfo"""
