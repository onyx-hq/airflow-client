...
class TestTitaniumUserCollectionItemRolesInner(unittest.TestCase):
    """TitaniumUserCollectionItemRolesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumUserCollectionItemRolesInner:
        """Test TitaniumUserCollectionItemRolesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumUserCollectionItemRolesInner`
        """
        model = TitaniumUserCollectionItemRolesInner()
        if include_optional:
            return TitaniumUserCollectionItemRolesInner(
                name = ''
            )
        else:
            return TitaniumUserCollectionItemRolesInner(
    ...
    def testTitaniumUserCollectionItemRolesInner(self):
        """Test TitaniumUserCollectionItemRolesInner"""
