...
class TestTitaniumVariable(unittest.TestCase):
    """TitaniumVariable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumVariable:
        """Test TitaniumVariable
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumVariable`
        """
        model = TitaniumVariable()
        if include_optional:
            return TitaniumVariable(
                key = '',
                description = '',
                value = ''
            )
