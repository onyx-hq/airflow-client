...
class TestTitaniumPluginCollectionItem(unittest.TestCase):
    """TitaniumPluginCollectionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumPluginCollectionItem:
        """Test TitaniumPluginCollectionItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumPluginCollectionItem`
        """
        model = TitaniumPluginCollectionItem()
        if include_optional:
            return TitaniumPluginCollectionItem(
                name = '',
                hooks = [
                    ''
                    ],
    ...
    def testTitaniumPluginCollectionItem(self):
        """Test TitaniumPluginCollectionItem"""
