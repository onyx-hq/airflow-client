...
class TestTitaniumXComCollection(unittest.TestCase):
    """TitaniumXComCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumXComCollection:
        """Test TitaniumXComCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumXComCollection`
        """
        model = TitaniumXComCollection()
        if include_optional:
            return TitaniumXComCollection(
                total_entries = 56,
                xcom_entries = [
                    titanium_airflow_client.models.x_com_collection_item.XComCollectionItem(
                        key = '', 
                        timestamp = '', 
                        execution_date = '', 
                        map_index = 56, 
    ...
    def testTitaniumXComCollection(self):
        """Test TitaniumXComCollection"""
