...
class TestTitaniumTaskInstanceReference(unittest.TestCase):
    """TitaniumTaskInstanceReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskInstanceReference:
        """Test TitaniumTaskInstanceReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskInstanceReference`
        """
        model = TitaniumTaskInstanceReference()
        if include_optional:
            return TitaniumTaskInstanceReference(
                task_id = '',
                dag_id = '',
                execution_date = '',
                dag_run_id = ''
    ...
    def testTitaniumTaskInstanceReference(self):
        """Test TitaniumTaskInstanceReference"""
