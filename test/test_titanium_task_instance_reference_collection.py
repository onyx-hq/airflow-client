...
class TestTitaniumTaskInstanceReferenceCollection(unittest.TestCase):
    """TitaniumTaskInstanceReferenceCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskInstanceReferenceCollection:
        """Test TitaniumTaskInstanceReferenceCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskInstanceReferenceCollection`
        """
        model = TitaniumTaskInstanceReferenceCollection()
        if include_optional:
            return TitaniumTaskInstanceReferenceCollection(
                task_instances = [
                    titanium_airflow_client.models.task_instance_reference.TaskInstanceReference(
                        task_id = '', 
                        dag_id = '', 
                        execution_date = '', 
                        dag_run_id = '', )
    ...
    def testTitaniumTaskInstanceReferenceCollection(self):
        """Test TitaniumTaskInstanceReferenceCollection"""
