...
class TestTitaniumDatasetEventCollection(unittest.TestCase):
    """TitaniumDatasetEventCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumDatasetEventCollection:
        """Test TitaniumDatasetEventCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumDatasetEventCollection`
        """
        model = TitaniumDatasetEventCollection()
        if include_optional:
            return TitaniumDatasetEventCollection(
                total_entries = 56,
                dataset_events = [
                    titanium_airflow_client.models.dataset_event.DatasetEvent(
                        dataset_id = 56, 
                        dataset_uri = '', 
                        ...
                        source_map_index = 56, 
                        created_dagruns = [
                            titanium_airflow_client.models.basic_dag_run.BasicDAGRun(
                                run_id = '', 
                                dag_id = '', 
    ...
    def testTitaniumDatasetEventCollection(self):
        """Test TitaniumDatasetEventCollection"""
