...
class TestTitaniumConfigSection(unittest.TestCase):
    """TitaniumConfigSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConfigSection:
        """Test TitaniumConfigSection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConfigSection`
        """
        model = TitaniumConfigSection()
        if include_optional:
            return TitaniumConfigSection(
                name = '',
                options = [
                    titanium_airflow_client.models.config_option.ConfigOption(
                        key = '', 
                        value = '', )
                    ]
            )
    ...
    def testTitaniumConfigSection(self):
        """Test TitaniumConfigSection"""
