...
class TestTitaniumMetadatabaseStatus(unittest.TestCase):
    """TitaniumMetadatabaseStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumMetadatabaseStatus:
        """Test TitaniumMetadatabaseStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumMetadatabaseStatus`
        """
        model = TitaniumMetadatabaseStatus()
        if include_optional:
            return TitaniumMetadatabaseStatus(
                status = 'healthy'
            )
        else:
            return TitaniumMetadatabaseStatus(
    ...
    def testTitaniumMetadatabaseStatus(self):
        """Test TitaniumMetadatabaseStatus"""
