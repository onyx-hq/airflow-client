...
class TestTitaniumTaskInstanceCollection(unittest.TestCase):
    """TitaniumTaskInstanceCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskInstanceCollection:
        """Test TitaniumTaskInstanceCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskInstanceCollection`
        """
        model = TitaniumTaskInstanceCollection()
        if include_optional:
            return TitaniumTaskInstanceCollection(
                total_entries = 56,
    ...
    def testTitaniumTaskInstanceCollection(self):
        """Test TitaniumTaskInstanceCollection"""
