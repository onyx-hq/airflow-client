...
class TestTitaniumExtraLink(unittest.TestCase):
    """TitaniumExtraLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumExtraLink:
        """Test TitaniumExtraLink
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumExtraLink`
        """
        model = TitaniumExtraLink()
        if include_optional:
            return TitaniumExtraLink(
    ...
    def testTitaniumExtraLink(self):
        """Test TitaniumExtraLink"""
