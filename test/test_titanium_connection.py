...
class TestTitaniumConnection(unittest.TestCase):
    """TitaniumConnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumConnection:
        """Test TitaniumConnection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumConnection`
        """
        model = TitaniumConnection()
        if include_optional:
            return TitaniumConnection(
                connection_id = '',
                conn_type = '',
                description = '',
                host = '',
    ...
    def testTitaniumConnection(self):
        """Test TitaniumConnection"""
