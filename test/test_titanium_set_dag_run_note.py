...
class TestTitaniumSetDagRunNote(unittest.TestCase):
    """TitaniumSetDagRunNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumSetDagRunNote:
        """Test TitaniumSetDagRunNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumSetDagRunNote`
        """
        model = TitaniumSetDagRunNote()
        if include_optional:
            return TitaniumSetDagRunNote(
                note = ''
            )
        else:
            return TitaniumSetDagRunNote(
    ...
    def testTitaniumSetDagRunNote(self):
        """Test TitaniumSetDagRunNote"""
