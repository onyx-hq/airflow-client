...
class TestTitaniumActionResource(unittest.TestCase):
    """TitaniumActionResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumActionResource:
        """Test TitaniumActionResource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumActionResource`
        """
        model = TitaniumActionResource()
        if include_optional:
            return TitaniumActionResource(
    ...
    def testTitaniumActionResource(self):
        """Test TitaniumActionResource"""
