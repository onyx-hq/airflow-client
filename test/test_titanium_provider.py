...
class TestTitaniumProvider(unittest.TestCase):
    """TitaniumProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumProvider:
        """Test TitaniumProvider
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumProvider`
        """
        model = TitaniumProvider()
        if include_optional:
