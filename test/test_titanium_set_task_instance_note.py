...
class TestTitaniumSetTaskInstanceNote(unittest.TestCase):
    """TitaniumSetTaskInstanceNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumSetTaskInstanceNote:
        """Test TitaniumSetTaskInstanceNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumSetTaskInstanceNote`
        """
        model = TitaniumSetTaskInstanceNote()
        if include_optional:
            return TitaniumSetTaskInstanceNote(
                note = ''
            )
        else:
            return TitaniumSetTaskInstanceNote(
    ...
    def testTitaniumSetTaskInstanceNote(self):
        """Test TitaniumSetTaskInstanceNote"""
