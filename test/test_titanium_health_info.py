...
class TestTitaniumHealthInfo(unittest.TestCase):
    """TitaniumHealthInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumHealthInfo:
        """Test TitaniumHealthInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumHealthInfo`
        """
        model = TitaniumHealthInfo()
        if include_optional:
            return TitaniumHealthInfo(
                metadatabase = titanium_airflow_client.models.metadatabase_status.MetadatabaseStatus(
                    status = 'healthy', ),
                scheduler = titanium_airflow_client.models.scheduler_status.SchedulerStatus(
                    status = 'healthy', 
                    latest_scheduler_heartbeat = '', ),
                triggerer = titanium_airflow_client.models.triggerer_status.TriggererStatus(
                    status = 'healthy', 
                    latest_triggerer_heartbeat = '', ),
                dag_processor = titanium_airflow_client.models.dag_processor_status.DagProcessorStatus(
                    status = 'healthy', 
    ...
    def testTitaniumHealthInfo(self):
        """Test TitaniumHealthInfo"""
