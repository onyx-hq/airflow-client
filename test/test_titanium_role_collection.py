...
class TestTitaniumRoleCollection(unittest.TestCase):
    """TitaniumRoleCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumRoleCollection:
        """Test TitaniumRoleCollection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumRoleCollection`
        """
        model = TitaniumRoleCollection()
        if include_optional:
            return TitaniumRoleCollection(
                total_entries = 56,
                roles = [
                    titanium_airflow_client.models.role.Role(
                        name = '0', 
                        actions = [
                            titanium_airflow_client.models.action_resource.ActionResource(
                                action = titanium_airflow_client.models.action.Action(
                                    name = '', ), 
                                resource = titanium_airflow_client.models.resource.Resource(
                                    name = '', ), )
                            ], )
                    ]
            )
    ...
    def testTitaniumRoleCollection(self):
        """Test TitaniumRoleCollection"""
