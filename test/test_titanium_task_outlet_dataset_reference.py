...
class TestTitaniumTaskOutletDatasetReference(unittest.TestCase):
    """TitaniumTaskOutletDatasetReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumTaskOutletDatasetReference:
        """Test TitaniumTaskOutletDatasetReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumTaskOutletDatasetReference`
        """
        model = TitaniumTaskOutletDatasetReference()
        if include_optional:
            return TitaniumTaskOutletDatasetReference(
                dag_id = '',
                task_id = '',
                created_at = '',
                updated_at = ''
    ...
    def testTitaniumTaskOutletDatasetReference(self):
        """Test TitaniumTaskOutletDatasetReference"""
