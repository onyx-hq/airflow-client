...
class TestTitaniumClearDagRun(unittest.TestCase):
    """TitaniumClearDagRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TitaniumClearDagRun:
        """Test TitaniumClearDagRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TitaniumClearDagRun`
        """
        model = TitaniumClearDagRun()
        if include_optional:
            return TitaniumClearDagRun(
                dry_run = True
            )
        else:
            return TitaniumClearDagRun(
    ...
    def testTitaniumClearDagRun(self):
        """Test TitaniumClearDagRun"""
